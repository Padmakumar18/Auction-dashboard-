...
const PlayerRegistrationPublic = () => {
        ...
        <Card className="max-w-md w-full text-center">
          <div className="mb-6">
            ...
            <p className="text-gray-600">
              Your player registration has been submitted successfully. You will
              be contacted soon with further details.
            </p>
          </div>
          <Button
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="pt-4">
              <Button
                ...
                className="w-full"
              >
                {loading ? "Submitting Registration..." : "Register Player"}
              </Button>
            </div>
          </form>
        </Card>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <ul className="text-sm text-blue-800 space-y-1">
                ...
                <li>• Jersey numbers must be between 1-99</li>
...
export default PlayerRegistrationPublic;
